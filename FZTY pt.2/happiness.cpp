...
void Happiness::on_pushButton_clicked()
{
    if (Character::GetInstance()->getMoney() >= 0) {
            Character::GetInstance()->setMoney(Character::GetInstance()->getMoney() - 0);
            Character::GetInstance()->setHappiness(Character::GetInstance()->getHappiness() + 1);
            if(Character::GetInstance()->getHappiness() > 100) {
...
void Happiness::on_pushButton_10_clicked()
{
    if (Character::GetInstance()->getMoney() >= 3000) {
            Character::GetInstance()->setMoney(Character::GetInstance()->getMoney() - 3000);
            Character::GetInstance()->setHappiness(Character::GetInstance()->getHappiness() + 45);
            if(Character::GetInstance()->getHappiness() > 100) {
                Character::GetInstance()->setHappiness(100);
            }
            emit updateHappiness();
